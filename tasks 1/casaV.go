...
func main() {
	...
	var (
		// надо подумать как хранить результат сдачи, нам надо знать какие банкноты и сколько дать в сдачи. Тоже можно использовать слайс от структуры banknota
		rest []banknota
		// также не надо забывать что для сдачи в кассе может денег не хватать, для этого сохранить какая сдача у нас сформировалась
		restSumma int
	)

	// мне нужно менять сумму для остатка, так как я должен понимать сколько еще осталось дать сдачи, после того как я выбрал какую то купюру
	// сначала  эта переменная  равна полной сдаче
	tempTotalRest := forRest

	// у нас в кассе банкноты сохранены от большей к меньшей. То есть мы спокойно обходим от большей к меньшей их по циклу.
